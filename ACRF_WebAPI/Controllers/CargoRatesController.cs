...
namespace ACRF_WebAPI.Controllers
{
    public class CargoRatesController : ApiController
    {
        ...
        [Route("api/CargoRates/AddCargoRates")]
        [HttpPost]
        ...
        [Route("api/CargoRates/UpdateCargoRates")]
        [HttpPut]
        [SessionAuthorizeFilter(UserType.AdminUser)]
        ...
        public IHttpActionResult DeleteCargoRates(int Id)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    result = objCrRtVM.DeleteCargoRates(Id, CreatedBy);
                }
                catch (Exception ex)
                {
                    ErrorHandlerClass.LogError(ex);
        ...
        #region api/CargoRates/ViewOneCargoRates (Get)

        [Route("api/CargoRates/ViewOneCargoRates")]
        [HttpGet]
        [SessionAuthorizeFilter(UserType.AdminUser)]
        ...
        [Route("api/CargoRates/ViewCargoRatesByPage")]
        [HttpGet]
        [SessionAuthorizeFilter(UserType.AdminUser)]
